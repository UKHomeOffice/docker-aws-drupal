...
RUN apt-get update \
    && apt-get -y install git mysql-client mysql-server apache2 libapache2-mod-php5 \
    pwgen python-setuptools vim-tiny php5-mysql php-apc php5-gd php5-curl php5-memcache memcached drush mc \
    && apt-get autoclean
